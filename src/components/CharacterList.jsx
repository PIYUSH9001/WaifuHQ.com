    ...
    return (
        <>
            <div className='container w-100 text-center p-2 d-flex align-items-center justify-content-center'>
                ...
                <button className={`btn btn-${ShowCharacterProperties.Color} rounded-circle CollapseBtn`} type="button" data-bs-toggle="collapse" data-bs-target="#CharactersTab" aria-expanded="false" aria-controls="CharactersTab"
                    onClick={() => {
            ...
            <div className='CharacterList row m-0 p-1 rounded-0 collapse' id='CharactersTab'>
