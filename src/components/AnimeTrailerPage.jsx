...
export default function AnimeTrailerPage() {
  ...
  return (
    <div className='container m-0 p-0 AnimeTrailerPage'>
        <Navbar/>
        <DashBoard TrailerURL={`https://www.youtube.com/embed/${AnimeTrailer}?controls=1&showinfo=0&autoplay=1&loop=1&modestbranding=1&rel=0&iv_load_policy=3&disablekb=1&fs=0`}/>
